...
// console.log(person6.friends); // ["a", "b", "c", "d"]

/* 实例一般都有属于自己的全部属性，但这里很尴尬。 因此很少有人单独使用原型模式 */
...
//     }
// };
// var person7 = new Person('CregskiN', 20, 'Engineer');
// var person8 = new Person('Nicholas', 29, 'Software Engineer');
// person7.friends.push('c');
// console.log(person8.friends); // ["a", "b"]

/* 构造函数模式+原型模式比单一原型模式更好，添加属性的工作交给构造函数，而不是直接在原型上定义。这是目前认同度最高的定义方式 */
...
//     return o;
// }
// var person9 = new Person('CregskiN', 20, 'Engineer');
// console.log(person9);

/* 寄生于构造函数模式，返回新的对象。 类似于工厂函数模式 + 构造函数模式 */
...
/* 寄生构造函数模式产生的实例对象，与构造函数产生的实例对象区别： */
// function Person(name, age, job) {
//     var o = {};
//     o.name = name;
//     o.age = age;
...
// }
// var person9 = new Person('CregskiN', 20, 'Engineer');
// console.log('寄生构造函数模式生成实例', person9);
...
//     }
// }
// var person10 = new Person10('CregskiN', 20, 'Engineer');
// console.log('构造函数模式生成实例', person10);
// console.log(person9.__proto__ === Object.prototype); // true
// console.log(person10.__proto__ === Person10.prototype); // true
...
//     return o;
// }
// var friend = Person('CregskiN', 20, 'Engineer');
// friend.sayName(); // CregskiN
